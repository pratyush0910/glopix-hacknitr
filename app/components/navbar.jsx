  ...
  return (
    <>
      <nav className="flex items-center justify-between bg-gray-800 text-white text-xl">
        <a
          href="/"
          className="cursor-pointer flex items-center p-1 flex-[40%] "
        >
        ...
        <ul className="flex justify-around">
          ...
          {user ? (
            <a
              ...
              className="p-2 mx-5 cursor-pointer border-2 border-solid bg-pink-500 rounded-lg font-bold"
            >
              LOGOUT
            </a>
          ) : (
            <a
              href="/api/auth/login"
              className="p-2 mx-5 cursor-pointer border-2 border-solid bg-pink-400 rounded-lg font-bold"
            >
              LOGIN
            </a>
          )}
